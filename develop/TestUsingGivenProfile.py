...
helper += "\t\t<profile>     - code for profile, must from {pfam, tax, k16}"
...
if pf not in ['pfam', 'k16', 'tax']:
    print("you must choose <profile> from {pfam, tax, k16}!")
    exit()
...
if pf == 'pfam':
    ...
    df_kmc = loadKMC(f"{base_dir}/k16.count.tsv") # k30.count.tsv
